...
public class AssignBinaryFunctionCell extends AccessBubbleDocsService {
	...
	public AssignBinaryFunctionCell(String token, int docId, String cellId, String expression) {
	...
	protected void dispatch() throws BubbleDocsException {
		...
		cell.setBinaryFunctionContent(expressionValue);
